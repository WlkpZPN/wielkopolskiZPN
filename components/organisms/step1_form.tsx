...
const StepOneForm = ({ data, handleChange, settings, readOnly, handleStepChange }) => {
  const {
    saveForm,
    handleStepFill,
    error,
      ...
      {loading ? (
        ...
        <FormTemplate onChange={() => clearErrors('stepOne')}>
          <Fieldset disabled={readOnly}>
            ...
            {data.leauge === 'futsal' ? (
              <Select
                ...
                onChange={(e) => handleChange(e.target.value, 'futsal_subtype', 1)}
              >
            ...
            <FormRow>
              <Label>
                ...
                <ZipCodeInput
                  ...
                  onChange={(e) => handleChange(e.target.value, 'clubZipCode', 1)}
                />
              </Label>
              <Label>
                Miasto
            ...
            <FormRow>
              ...
              <Label>
                ...
                <Input
                  ...
                  onChange={(e) => handleChange(e.target.value, 'agentLastName', 1)}
                  type="text"
                ></Input>
              </Label>
            </FormRow>
            ...
            <FormRow>
              <Label>
                ...
                <Input
                  ...
                  onChange={(e) => handleChange(e.target.value, 'agentEmail', 1)}
                />
              </Label>
              <Label>
                ...
                <PhoneInput
                  ...
                  onChange={(e) => handleChange(e.target.value, 'agentPhone', 1)}
                />
              </Label>
            </FormRow>
          </Fieldset>
          <FormRow margin="48px 0" cols={3}>
            {show_buttons && (
              <PrimaryButton type="button" color="dark" hoverColor="darkLight" onClick={saveForm}>
            ...
            <PrimaryButton
              type="button"
              onClick={() => (show_buttons ? handleStepChange('next') : setStep(2))}
            >
              Kolejny krok
            </PrimaryButton>
          </FormRow>
