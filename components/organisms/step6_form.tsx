...
"
          ...
          handleChange={() => handleChange(!formData.havingFootballStaff, 'havingFootballStaff', 6)}
        ...
        <FormStatement
          ...
          handleChange={() =>
            handleChange(!formData.HavingSecurityServices, 'HavingSecurityServices', 6)
          }
      ...
      <div style={{ marginBottom: '32px' }}>
        <PrimaryButton
          ...
          onClick={() => (show_buttons ? handleStepChange('previous') : setStep(5))}
        >
          Cofnij
        </PrimaryButton>
        {show_buttons ? (
