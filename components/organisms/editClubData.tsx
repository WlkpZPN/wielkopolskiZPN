...
const EditClubData = ({ clubData, isAdmin = false }) => {
  ...
  const [postal_city, postal_street, postal_zipCode] = extractAddressData(clubData.postal_address);
  const [stadium_city, stadium_street, stadium_zipCode] = extractAddressData(clubData.stadium);
  ...
  const [chairmanEmail, setChairmanEmail] = useState(clubData.chairman_email || '');
  ...
  const [chairmanPhone, setChairmanPhone] = useState(clubData.chairman_phone || '');
  ...
  const [landlinePhone, setLandlinePhone] = useState(clubData.landline_phone || '');
