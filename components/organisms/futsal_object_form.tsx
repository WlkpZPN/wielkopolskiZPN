          ...
          <FormRow>
            <Label>
              ...
              <ZipCodeInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'postal_code')}
              />
            </Label>
            <Label>
              Miasto
...
"
          ...
          {data.I01_1 === false ? (
            <>
              ...
              <Label pointer margin="16px 0" direction="row">
                ...
                />
                Umowa gwarantuje prawo do korzystania z obiektu przez cały sezon,w którym ubiegamy
                się o licencję
              </Label>
            </>
          ) : null}
          ...
          <Label pointer margin="24px 0" direction="row">
            <span>
              ...
              przed wejściem na obiekt. Regulaminy zawodów piłkarskich niebędących imprezą masową w
              formacie nie mniejszym niż B1 (70cm x 100cm) rozmieszczone są przed każdym wejściem w
              taki sposób,by widzowie mogli je przeczytać. Właściwe przepisy prawa powszechnego
              nakładają na Klub obowiązek posiadania regulaminu imprezy masowej. Regulaminy imprezy
              masowej,w formacie nie mniejszym niż B1 (70cm x 100cm) rozmieszczone są przed każdym
              wejściem w taki sposób, by widzowie mogli je przeczytać przed wejściem na obiekt.
            </span>
          </Label>
          ...
          <Label width="max-content">
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I02_audience_capacity')}
              suffix={null}
              placeholder="0"
            />
          </Label>
          <Label width="max-content">
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I02_audience_entrance')}
              suffix={null}
              placeholder="0"
            />
          </Label>
          ...
          <Label width="max-content">
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I03_lighting')}
              suffix="lx"
              placeholder="0"
            />
          </Label>
          ...
          <Label>
            ...
            >
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.rawValue, objectIndex, 'I04_length')}
                suffix="m"
                placeholder="0"
              />
              ...
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.rawValue, objectIndex, 'I04_width')}
                suffix="m"
                placeholder="0"
              />
            </div>
          ...
          <Label>
            ...
            <NumericInput
              value={data.I04_1}
              onChange={(e) => handleChange(e.target.rawValue, objectIndex, 'I04_1')}
              suffix="m"
              placeholder="0"
            />
          </Label>
          <Label>
            ...
            <NumericInput
              value={data.I04_2}
              onChange={(e) => handleChange(e.target.rawValue, objectIndex, 'I04_2')}
              suffix="m"
              placeholder="0"
            />
          </Label>
          <Label>
            <span>Odległość linii końcowej do siatki/piłkochwytów za bramką</span>
            <NumericInput
              value={data.I04_3}
              onChange={(e) => handleChange(e.target.rawValue, objectIndex, 'I04_3')}
              suffix="m"
              placeholder="0"
            />
          </Label>
          ...
          <Label width="50%">
            ...
            <Input
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I05_secondary_color')}
            />
          </Label>
          <Label width="50%">
            Materiał
            <Input
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I05_material')}
            />
          </Label>
          <Label pointer margin="24px 0" direction="row">
            <span>
              <RadioSquare
                ...
                handleChange={() => handleChange(!data.I05_lines, objectIndex, 'I05_lines')}
              />
          ...
          <Label width="50%">
            ...
            <Input
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I05_dyscyplines')}
            />
          </Label>
          ...
          <Label width="50%">
            ...
            <Input
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I06_material')}
            />
          </Label>
          <Label width="50%">
            Kolor bramek
            <Input
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I06_color')}
            />
          </Label>
          ...
          <Label pointer margin="24px 0" direction="row">
            <span>
              <RadioSquare
                value={data.I06_base}
                handleChange={(e) => handleChange(!data.base, objectIndex, 'I06_base')}
              />
          ...
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I07_first_half_capacity')}
              placeholder={null}
              suffix={null}
            />
          </Label>
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) =>
                handleChange(e.target.value, objectIndex, 'I07_second_half_capacity')
              }
              placeholder={null}
              suffix={null}
            />
          ...
          <Label pointer margin="24px 0 16px 0" direction="row">
            <span>
              <RadioSquare
                ...
                handleChange={() => handleChange(!data.I07_1, objectIndex, 'I07_table')}
              />
              Stolik
            </span>
          </Label>
          ...
          <Label>
            ...
            <Select
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I08_clock')}
            >
          ...
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I08_scoreboards')}
              placeholder={null}
              suffix={null}
            />
          </Label>
          <Label>
            ...
            <Select
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I08_sound')}
            >
          ...
          <Label>
            ...
            <span style={{ display: 'flex', alignItems: 'center' }}>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I09_length')}
                placeholder={'0'}
                suffix={'m'}
              />
              <span style={{ margin: '0 8px', marginBottom: '-8px' }}>x</span>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I09_width')}
                placeholder={'0'}
                suffix={'m'}
              />
            </span>
          ...
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I09_hygiene')}
              placeholder={'0'}
              suffix={null}
            />
          </Label>
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I09_showers')}
              placeholder={'0'}
              suffix={null}
            />
          </Label>
          ...
          <Label>
            ...
            <span style={{ display: 'flex', alignItems: 'center' }}>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I09_guest_length')}
                placeholder={'0'}
                suffix={'m'}
              />
              <span style={{ margin: '0 8px', marginBottom: '-8px' }}>x</span>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I09_guest_width')}
                placeholder={'0'}
                suffix={'m'}
              />
            </span>
          ...
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I09_guest_hygiene')}
              placeholder={'0'}
              suffix={null}
            />
          </Label>
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I09_guest_showers')}
              placeholder={'0'}
              suffix={null}
            />
          </Label>
          <Label pointer margin="24px 0 16px 0" direction="row">
            <span>
              <RadioSquare
                value={data.I09_exit}
                handleChange={() => handleChange(!data.I10_1, objectIndex, 'I09_exit')}
              />
          ...
          <Label>
            ...
            <span style={{ display: 'flex', alignItems: 'center' }}>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I10_width')}
                placeholder={'0'}
                suffix={'m'}
              />
              <span style={{ margin: '0 8px', marginBottom: '-8px' }}>x</span>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I10_length')}
                placeholder={'0'}
                suffix={'m'}
              />
            </span>
          ...
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I10_hygiene')}
              placeholder={'0'}
              suffix={null}
            />
          </Label>
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I10_showers')}
              placeholder={'0'}
              suffix={null}
            />
          </Label>
          ...
          <Label>
            ...
            <Select
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I11_heating')}
            >
          ...
          <Label pointer>
            <span>
              <RadioSquare
                ...
                handleChange={() =>
                  handleChange(!data.I11_air_conditioning, objectIndex, 'I11_air_conditioning')
                }
              />
          ...
          <Label pointer>
            <span>
              <RadioSquare
                ...
                handleChange={() => handleChange(!data.I12_stretcher, objectIndex, 'I12_stretcher')}
              />
          ...
          <Label pointer>
            <span>
              <RadioSquare
                ...
                handleChange={() =>
                  handleChange(!data.I12_medical_service, objectIndex, 'I12_medical_service')
                }
              />
          ...
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I13_capacity')}
              placeholder={null}
              suffix={null}
            />
          </Label>
          <Label pointer>
            <span>
              <RadioSquare
                ...
                handleChange={() =>
                  handleChange(!data.I13_internet_access, objectIndex, 'I13_internet_access')
                }
              />
          ...
          <Label pointer>
            <span>
              <RadioSquare
                ...
                handleChange={() =>
                  handleChange(!data.I13_separate_press, objectIndex, 'I13_separate_press')
                }
              />
          ...
          <Label>
            <span>
              ...
              <Info
                text={'np. na trybunie widowni, na balkonie, na piętrze oddzielone od widowni'}
              />
            </span>
            <Input
              type="text"
              value={data.I13_separate_media}
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I13_separate_media')}
            />
          </Label>
          ...
          <span style={{ display: 'flex' }}>
            <h3>Jaki system reklamy używany jest na hali sportowej podczas zawodów sportowych?</h3>
          ...
          <Label pointer>
            <span>
              <RadioSquare
                ...
                handleChange={() => handleChange(!data.I14_fixed, objectIndex, 'I14_fixed')}
              />
              Stałe bandy
            </span>
          </Label>
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I14_fixed_quantity')}
              placeholder={null}
              suffix={null}
            />
          </Label>
          <Label>
            ...
            <span style={{ display: 'flex', alignItems: 'center' }}>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I14_fixed_length')}
                placeholder={'0'}
                suffix={'m'}
              />
              <span style={{ margin: '0 8px', marginBottom: '-8px' }}>x</span>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I14_fixed_width')}
                placeholder={'0'}
                suffix={'m'}
              />
            </span>
          ...
          <Label pointer>
            <span>
              <RadioSquare
                ...
                handleChange={() => handleChange(!data.I14_moving, objectIndex, 'I14_moving')}
              />
              Bandy obrotowe
            </span>
          </Label>
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I14_moving_quantity')}
              placeholder={null}
              suffix={null}
            />
          </Label>
          <Label>
            ...
            <span style={{ display: 'flex', alignItems: 'center' }}>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I14_moving_width')}
                placeholder={'0'}
                suffix={'m'}
              />
              <span style={{ margin: '0 8px', marginBottom: '-8px' }}>x</span>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I14_moving_length')}
                placeholder={'0'}
                suffix={'m'}
              />
            </span>
          ...
          <Label pointer>
            <span>
              <RadioSquare
                ...
                handleChange={() => handleChange(!data.I14_electric, objectIndex, 'I14_electric')}
              />
              Bandy elektroniczne
            </span>
          </Label>
          <Label>
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I14_electric_quantity')}
              placeholder={null}
              suffix={null}
            />
          </Label>
          <Label>
            ...
            <span style={{ display: 'flex', alignItems: 'center' }}>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I14_electric_width')}
                placeholder={'0'}
                suffix={'m'}
              />
              <span style={{ margin: '0 8px', marginBottom: '-8px' }}>x</span>
              <NumericInput
                ...
                onChange={(e) => handleChange(e.target.value, objectIndex, 'I14_electric_length')}
                placeholder={'0'}
                suffix={'m'}
              />
            </span>
          ...
          <FormHeader>Kryterium I.15 - Miejsca parkingowe wokół hali</FormHeader>
          {error.step === 15 ? (
            <>
              <ErrorMessage>{error.text}</ErrorMessage>{' '}
            </>
          ...
          <Label width="50%">
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I15_parking_sports')}
              suffix=""
              placeholder="0"
            />
          </Label>
          <Label width="50%">
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I15_special_spots')}
              suffix=""
              placeholder="0"
            />
          </Label>
          ...
          <Label width="50%">
            ...
            <NumericInput
              ...
              onChange={(e) => handleChange(e.target.value, objectIndex, 'I16_service')}
              suffix=""
              placeholder="0"
            />
          </Label>
