...
//components
import { getCurrentDate, renderAmount, renderMainAmount } from '../middleware/utils';
    ...
    if (
      ...
      return (
        <>
          ...
          <Paragraph>
            Wnisoki licencyjne będze można składać w okresie od {settings.start_date} do{' '}
            {settings.end_date}
          </Paragraph>
        </>
      );
    ...
    if (clubData.applications.length > 0) {
      ...
      switch (clubData.applications[0].status_id) {
        ...
        case 2:
          return (
            <>
              <Header color="success">Dziękujemy za złożenie wniosku licencyjnego.</Header>
              <Paragraph>
                Niezwłocznie po rozpatrzeniu wniosku otrzymasz informację czy wniosek został
                zaakceptowany przez Wielkopolski ZPN. Dalsze kroki procedury licencyjnej możesz
                zobaczyć poniżej:
              </Paragraph>
        ...
        case 3:
          return (
            <>
              <Header color="success">Dziękujemy! Poczekaj na akceptację wniosku</Header>
              <Paragraph>
                Dziękujemy za złożenie wniosku liencyjnego. <br /> Najpóźniej 20 kwietnia{' '}
                {new Date().getFullYear()} otrzymasz informację czy wniosek został zaakceptowany
                przez Wielkopolski ZPN. <br /> Dalsze kroki procedury licencyjnej możesz zobaczyć
                poniżej{' '}
              </Paragraph>
              <ClubSteps status="wnioskowany" />
              <ClubApplication
          ...
          return (
            <>
              ...
              <Paragraph>
                ...
                Zapoznaj się z poniższym uzasadnieniem oraz prosimy o wprowadzenie poprawek do
                wniosku
              </Paragraph>
              ...
              >
                ...
                <br />
                Prosimy o załączanie brakujących plików tylko w ostatnim kroku o nazwie
                &quot;Załączniki&quot;. Po wprowadzeniu poprawek wyślij wniosek ponownie używając
                zielonego przycisku &quot;Wyślij poprawiony wniosek&quot;.
              </p>
              <ClubApplication
                show_buttons={true}
          ...
          return (
            <>
              ...
              <Paragraph>
                ...
                Zapoznaj się z poniższym uzasadnieniem, aby ubiegać się o przyznanie licencji
                klubowej należy złożyć nowy wniosek
              </Paragraph>
              <p>Powód: </p>
              <ErrorMessage>{clubData.applications[0].reject_reason}</ErrorMessage>
              {loading ? (
                <Spinner />
              ) : (
                <PrimaryButton onClick={newApplication}>Utwórz nowy wniosek</PrimaryButton>
              )}
            </>
          );
        case 6:
          return (
            <>
              <Header color="success">
                Twój wniosek został zaakceptowany. Prosimy o dokonanie płatności.
              </Header>
              ...
              >
                ...
                {clubData.applications[0].invoice_url || clubData.applications[0].invoice_url_2 ? (
                  <>
        ...
        case 7:
          return (
            <>
              {' '}
              <Header color="success">Płatność za wniosek została wykonana</Header>{' '}
              <Paragraph>
                Opłaciłeś swój wniosek. Poczekaj aż Wielkopolski ZPN zweryfikuje płatność.
              </Paragraph>
              <div>
                <AddInvoiceWrapper admin={false} clubData={clubData} />
              </div>
        ...
        case 10:
          return (
            <>
              ...
              <Paragraph>
                Komisja Licencyjna Wielkopolskiego ZPN przyznała Twojemu klubowi licencję.
              </Paragraph>
              <div
                style={{
                  margin: '70px 0',
        ...
        case 9:
          return (
            <>
              ...
              <Paragraph>
                Wielkopolski ZPN odrzucił Twoją licencję z następujących przyczyn:
              </Paragraph>
              <ErrorMessage>{clubData.applications[0].reject_reason}</ErrorMessage>
              <p></p>
            </>
        ...
        {clubData.applications[0].is_new_season ? (
          <>
            ...
            <Paragraph style={{ maxWidth: '700px' }}>
              ...
              uzupełnionego poprzednimi danymi. Sprawdź wszystkie pola,uzupełnij te brakujące i
              wyślij wniosek licencyjny do WielkopolskiegoZPN{' '}
            </Paragraph>
            <PrimaryButton onClick={() => newApplication()}>
              Złóż ponownie wniosek licencyjny
            </PrimaryButton>
            {clubData.applications[0].status_id == 8 || clubData.applications[0].status_id == 10 ? (
              <>
                {' '}
...
export const getServerSideProps = protectedClientRoute(async (context, data) => {
  ...
  if (clubData?.applications.length === 0) {
    ...
    await prisma.applications.update({
      ...
      data: {
        internal_id: `W/${new Date().getFullYear()}/${newApplication.id.toLocaleString('en-US', {
