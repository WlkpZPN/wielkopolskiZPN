    ...
    <table style="
      ...
      <tr style="padding: 0">
        <td style="margin: 0; padding: 16px 48px; background-color: #0156a6">
          <h1 style="font-weight:bold; margin: 0; padding: 0; color: white">Wniosek licencyjny pomyślnie złożony</h1>
        </td>
      </tr>
      <tr>
        <td style="padding: 32px 48px">
        ...
        ${description}
          ...
          Zaloguj się na swoje konto na platformie licencyjnej, aby sprawdzić przebieg wydania licencji.
        </p>
        </>
